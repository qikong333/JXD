...
import {HttpInterceptHeadleProvider} from "../http-intercept-headle/http-intercept-headle";

@Injectable()
export class HttpInterceptProvider extends Http {
  constructor(backend: ConnectionBackend, defaultOptions: RequestOptions, public _: HttpInterceptHeadleProvider) {
